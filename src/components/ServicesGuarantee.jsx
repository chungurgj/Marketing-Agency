...
const ServicesGuarantee = () => {
  return (
    <div className='flex justify-center gap-8 items-center bg-green-100 min-h-[300px]'>
        ...
        <p className='hidden md:block text-sm'>At Marketing Agency, we're dedicated to driving meaningful growth for your business. Our promise is simple: if we don't deliver a significant 
