...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 z-50'>
        <div className={`fixed top-0 left-0 h-screen bg-slate-50 sm:hidden w-[65%] transform transition-all ease-in-out duration-300
        ${openSideMenu ? 'translate-x-0' : '-translate-x-full'}`}>
            ...
            <ul className='flex flex-col justify-center items-center  '>
                <li className='sidebar-element'><a href='/'>Home</a></li>
                <li className='sidebar-element'><a href='/about'>About Us</a></li>
                <li className='sidebar-element'><a href='/services'>Services</a></li>
            </ul>
